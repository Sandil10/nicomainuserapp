...
class WaterBottlesPage extends StatefulWidget {
  final Function(Map<String, dynamic>) onAddToCart;

  const WaterBottlesPage({Key? key, required this.onAddToCart})
      : super(key: key);

  @override
  State<WaterBottlesPage> createState() => _WaterBottlesPageState();
}

class _WaterBottlesPageState extends State<WaterBottlesPage> {
  ...
  void _startLoadingData() async {
    ...
    _streamSubscription = FirebaseFirestore.instance
        ...
        .where('category', isEqualTo: 'Water Bottles')
        .snapshots()
        .listen((snapshot) {
      if (!mounted) return;
        ...
        children: [
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      AppLocalization.getText('waterBottles'),
                      style:
          ...
          Padding(
            ...
            child: TextField(
              ...
              style: const TextStyle(
                  color: Colors.black), // 👈 This line makes typed text black
              decoration: InputDecoration(
                hintText: AppLocalization.getText('searchWaterBottles'),
  ...
  Widget _buildContent() {
    if (_isLoading) {
      return const Center(child: SmallWaveLoader());
    }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              AppLocalization.getText('noWaterBottlesFound'),
              style: const TextStyle(
                  fontSize: 16,
...
class _WaterBottlesListItem extends StatefulWidget {
  final Map<String, dynamic> product;
  final Function(Map<String, dynamic>) onAddToCart;
  final VoidCallback onImageTap;

  const _WaterBottlesListItem({
    Key? key,
  ...
  @override
  _WaterBottlesListItemState createState() => _WaterBottlesListItemState();
}

class _WaterBottlesListItemState extends State<_WaterBottlesListItem> {
  int _quantity = 1;
  late String _unit;
  ...
  void initState() {
    super.initState();
    _unit = widget.product['uom']?.toLowerCase() ?? 'bottle';
  ...
  Widget _buildProductImage(String? imageUrl) {
    Widget fallbackImage = Container(
      ...
      child: Center(
        child: Icon(Icons.water_drop, color: Color(0xFF5B35B8), size: 24),
      ),
    );
  ...
  @override
  Widget build(BuildContext context) {
    final name = widget.product['name'] ?? 'Water Bottle';
