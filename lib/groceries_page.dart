...
class _GroceriesPageState extends State<GroceriesPage> {
  ...
  void _startLoadingData() {
    print("🔥 Starting to load Groceries data...");
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          AppLocalization.getText('groceries'),
                          style: const TextStyle(
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: AppLocalization.getText('searchGroceries'),
                    hintStyle:
...
class _GroceryListItem extends StatefulWidget {
  final Map<String, dynamic> product;
  final int cartQty;
  final Function(Map<String, dynamic>) onAddToCart;
  final VoidCallback onImageTap;

  const _GroceryListItem({
    Key? key,
...
class _GroceryListItemState extends State<_GroceryListItem> {
  late int _localQty;
  late String _unit;
  ...
  @override
  void didUpdateWidget(_GroceryListItem oldWidget) {
  ...
  @override
  Widget build(BuildContext context) {
    final name = widget.product['name']?.toString() ?? 'Grocery Item';
